...
//========================USEFUL VARIABLES=============================
int UTC = 8; // UTC = value in hour (SUMMER TIME) [For example: Paris UTC+2 => UTC=2]

const char *ssid     = "hhx"; 
const char *password = "hhx041102";
...
void loop() {
  ...
  timeClient.setTimeOffset(8 * 3600);} // Change daylight saving time - Summer
